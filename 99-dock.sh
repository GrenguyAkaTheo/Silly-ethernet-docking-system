...
###            runuser -u "$TARGET_USER" -- sshfs <Your slave machines username>@10.10.10.2:/ /path/to/mount/directory -o reconnect,ServerAliveInterval=5,ServerAliveCountMax=3,idmap=user,IdentityFile=/home/theo/.ssh/id_ed25519
